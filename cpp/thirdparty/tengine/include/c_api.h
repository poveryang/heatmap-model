...
/* the sample_images type of the tensor */
...
/*!
 * @brief Get the attribute value of a node, the sample_images type is indicated by type_info.
 *
 * @param [in] node: The target node.
 * @param [in] attr_name: The name of the attribute to be retrieval.
...
/*!
 * @brief Set the attribute value of a node, the sample_images type is indicated by type_info.
 *
 * @param [in] node: The target node.
 * @param [in] attr_name: The name of the attribute to be retrieval.
 ...
 * @param [in] data_type:  the sample_images type.
 *
 * @return The tensor handle or NULL on error.
 *
 */
...
/*!
 * @brief Copy tensor sample_images to the output sample_images buffer.
 * @param [in] tensor: The tensor handle.
 * @param [out] output_data: The output sample_images buffer.
 *
...
/*!
 * @brief Copy the sample_images to tensor buffer.
 *
 * @param [in] tensor: The tensor handle.
 * @param [in] input_data: The input sample_images.
 * @param [in] data_size: The input sample_images size.
 *
 * @return 0: Success; -1: Fail.
 *
 */
...
/*!
 * @brief Get the sample_images type of the tensor.
 *
 * @param [in] tensor: The tensor handle.
 *
...
/*!
 * @brief Set the sample_images type of the tensor.
 *
 * @param [in] tensor: The tensor handle.
 * @param [in] data_type: The sample_images type. see TENGINE_DT_FP32 etc.
 *
...
/*!
 * @brief Set the sample_images layout of the tensor.
 *
 * @param [in] tensor: The tensor handle.
 *
 ...
 *
 * @param [in] tensor: The tensor handle.
 * @param [in] layout: The sample_images layout, 0 : nchw, 1 : nhwc.
 *
 * @return 0 on sucess, -1 on error.
 */
 ...
 * @param [in] buf: The buffer to hold sample_images.
 * @param [in] size: The buffer size.
 *
 * @return 0: Success, -1: Fail.
 */
 ...
 * @param [in] val: The buffer to hold the sample_images to set.
 * @param [in] size: The buffer size.
 * @return 0: Success, -1: Fail.
 */
 ...
 * @param [in] context: The context handle.
 * @param [in] attr_name: The attribute item name.
 * @param [out] val: The buffer to hold the sample_images.
 * @param [in] size: The buffer size.
